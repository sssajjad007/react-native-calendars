...
var pSetLocale = function () {
  XDate.locales['fa'] = {
    ...
    monthNames: ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'شهریور', 'مرداد', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
    today: 'امروز'
  };
};
...
function pDateDay(xd) {
  ...
  if (Object.prototype.hasOwnProperty.call(cache.dates, key)) {
...
function sameMonth(a, b, jalali = false) {
  ...
  if (Object.prototype.hasOwnProperty.call(cache.sameMonth, key)) {
...
function month(xd, jalali = false) {
  const key = xd.toDateString();
  if (Object.prototype.hasOwnProperty.call(cache.months, key)) return cache.months[key];
